...
namespace MemberPortal.Models
{
    ...
    public class MockDatabase
    {
        ...
        [Range(1,5,ErrorMessage ="Entered Member ID is not valid!")]
        
        public int MemberID { get; set; }


        [Required(ErrorMessage = "Policy ID can't be empty!")]
        [Range(1,5, ErrorMessage = "Entered Policy ID is not valid!")]
        public int PolicyID { get; set; }


        [Required(ErrorMessage = "Claim ID can't be empty!")]
        [Range(1,5, ErrorMessage = "Entered Claim ID is not valid!")]
        ...
        [Range(1,5, ErrorMessage = "Entered Hospital ID is not valid!")]
